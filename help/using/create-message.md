...
1. Define the message properties.
    ...
    * Select the **[!UICONTROL Preset]** to use for the message.
        ...
        Presets include all the parameters that are required for an email and/or push notification to be sent according to your brand. [Learn more about branding](../using/administration.md#cjm-branding).
