...
* **optionSelection**
    ...
    * **Profile Constraint Type**
        ...
        **Type:** string
        **Possible values:** "directList", "filter"
        **Default value:** "none"
...
**Description:** Decision end date and end time. The property has the semantic of schema.org's 'endTime' property defined on http://schema.org/Action.
**Type:** string
...
**Description:** Decision start date and end time. The property has the semantic of schema.org's 'startTime' property defined on http://schema.org/Action.
**Type:** string
