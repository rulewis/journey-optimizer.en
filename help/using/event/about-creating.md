...
You can use the simple expression editor or the advanced expression editor to setup conditions on events. [Read more](../building-journeys/expression/expressionadvanced.md).
